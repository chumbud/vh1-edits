...
function loaded () {
	myScroll = new IScroll('#column1', { scrollbars: true, mouseWheel: true, interactiveScrollbars: true });
	myScroll2 = new IScroll('#column2', { scrollbars: true, mouseWheel: true, interactiveScrollbars: true });
}
